...
const courseData = [
    ...
    {
        id: "u4",
        title: "Unidad 4: Fisiología Shaoyang",
        description: "Bisagra, Medio-Interior Medio-Exterior",
        theme: "green",
        chapters: [
            {
                id: "u4-c1",
                title: "Introducción a Shaoyang",
                subtitle: "Capítulo 1",
                image: "https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?auto=format&fit=crop&w=1200&q=80",
                content: {
                    heading: "Shaoyang: El Pivote",
                    description: "La bisagra que conecta el exterior (Taiyang) con el interior (Yangming). Es el mecanismo que permite la comunicación y el flujo del Qi.",
                    cards: [
                        {
                            title: "La Bisagra",
                            icon: <Activity className="w-6 h-6" />,
                            shortText: "Apertura y Cierre",
                            modalTitle: "Mecanismo de Pivote",
                            modalContent: "Shaoyang actúa como una puerta giratoria. Si se bloquea, el Qi no puede entrar ni salir, causando desarmonía en todo el cuerpo."
                        },
                        {
                            title: "Medio-Int / Medio-Ext",
                            icon: <Layout className="w-6 h-6" />,
                            shortText: "Zona Intermedia",
                            modalTitle: "Ni dentro ni fuera",
                            modalContent: "El patógeno ya no está en la superficie (no se puede sudar) pero no ha entrado completamente al interior (no se puede purgar)."
                        },
                        {
                            title: "Fuego Ministerial",
                            icon: <Flame className="w-6 h-6" />,
                            shortText: "Fuego Pequeño",
                            modalTitle: "El Fuego de la Vesícula",
                            modalContent: "A diferencia del Fuego Imperial del Corazón, este es un fuego funcional necesario para la digestión y el movimiento, pero volátil."
                        }
                    ]
                }
            },
            {
                ...
                title: "Canales y Órganos",
                subtitle: "Capítulo 2",
                image: "https://images.unsplash.com/photo-1500829243541-74b677fecc30?auto=format&fit=crop&w=1200&q=80",
                content: {
                    heading: "Vesícula y San Jiao",
                    description: "El sistema de la Madera y el Fuego. La Vesícula Biliar toma decisiones y el San Jiao gestiona los caminos del agua y el Qi original.",
                    cards: [
                        {
                            title: "Vesícula Biliar",
                            icon: <Brain className="w-6 h-6" />,
                            shortText: "Zu Shaoyang",
                            modalTitle: "El Juez de la Decisión",
                            modalContent: "Controla el juicio y el coraje. Fisiológicamente, almacena y excreta la bilis pura para ayudar en la digestión."
                        },
                        {
                            title: "San Jiao",
                            icon: <Droplets className="w-6 h-6" />,
                            shortText: "Shou Shaoyang",
                            modalTitle: "El Triple Recalentador",
                            modalContent: "No tiene forma física, es una función. Coordina la transformación del Qi y el paso de los líquidos en los tres Jiaos."
                        },
                        {
                            title: "Relación Madera-Tierra",
                            icon: <Activity className="w-6 h-6" />,
                            shortText: "Control",
                            modalTitle: "Invasión de Madera a Tierra",
                            modalContent: "Si Shaoyang se estanca, la Madera ataca a la Tierra (Bazo/Estómago), causando náuseas, falta de apetito y problemas digestivos."
                        }
                    ]
                }
            },
            {
                id: "u4-c3",
                title: "Shaoyang y Shang Han Lun",
                subtitle: "Capítulo 3",
                image: "https://images.unsplash.com/photo-1519681393784-d120267933ba?auto=format&fit=crop&w=1200&q=80",
                content: {
                    heading: "El Conflicto",
                    description: "En el Shang Han Lun, la etapa Shaoyang representa una lucha entre el Qi correcto (Zheng Qi) y el patógeno (Xie Qi) que va y viene.",
                    cards: [
                        {
                            title: "Lucha Intermitente",
                            icon: <Wind className="w-6 h-6" />,
                            shortText: "Ir y Venir",
                            modalTitle: "Alternancia",
                            modalContent: "El síntoma sello es la alternancia de fiebre y escalofríos. Refleja la batalla ganada y perdida momentáneamente entre el cuerpo y el factor patógeno."
                        },
                        {
                            title: "Los 3 Métodos Prohibidos",
                            icon: <X className="w-6 h-6" />,
                            shortText: "Contraindicaciones",
                            modalTitle: "No Sudar, No Purgar, No Vomitar",
                            modalContent: "Como está en el medio, sudar daña el Yin/Sangre, purgar daña el interior, y vomitar daña el Qi. Solo se puede ARMONIZAR."
                        },
                        {
                            title: "Armonización",
                            icon: <Shield className="w-6 h-6" />,
                            shortText: "He Jie",
                            modalTitle: "El Método de Armonizar",
                            modalContent: "El objetivo es desbloquear el pivote para que el cuerpo expulse el patógeno por sí mismo o lo resuelva internamente."
                        }
                    ]
                }
            },
            {
                id: "u4-c4",
                title: "Patología Shaoyang",
                subtitle: "Capítulo 4",
                image: "https://images.unsplash.com/photo-1505506874110-6a7a69069a08?auto=format&fit=crop&w=1200&q=80",
                content: {
                    heading: "Síndrome Shaoyang",
                    description: "Zhang Zhong Jing define: 'En la enfermedad Shaoyang, hay boca amarga, garganta seca y visión borrosa'.",
                    cards: [
                        {
                            title: "Síntomas Principales",
                            icon: <Thermometer className="w-6 h-6" />,
                            shortText: "Cuadro Clínico",
                            modalTitle: "La Tríada Shaoyang",
                            modalContent: "1. Boca amarga (Fuego de VB sube).\n2. Garganta seca (Fuego consume fluidos).\n3. Visión borrosa (Fuego perturba los ojos/hígado)."
                        },
                        {
                            title: "Otros Síntomas",
                            icon: <Activity className="w-6 h-6" />,
                            shortText: "Malestar",
                            modalTitle: "Plenitud y Náuseas",
                            modalContent: "Plenitud en el hipocondrio y el pecho (estancamiento de Qi), falta de ganas de comer y náuseas (invasión a Estómago)."
                        },
                        {
                            title: "Xiao Chai Hu Tang",
                            icon: <Zap className="w-6 h-6" />,
                            shortText: "La Fórmula",
                            modalTitle: "Decocción de Bupleurum Menor",
                            modalContent: "La fórmula maestra para armonizar. Chai Hu abre el pivote, Huang Qin limpia el calor, Ban Xia armoniza el estómago, Ren Shen tonifica el Qi."
                        }
                    ]
                }
            }
        ...
        text-left border-l-4 ${isActive ? `bg-slate-800 ${t.border} text-white shadow-lg ${t.shadow}`
                ...
                {isActive &&
                    <CheckCircle2 size={16} className={`ml-2 transition-colors duration-300 ${themeColor === 'blue'
                        ? 'text-emerald-500' : themeColor === 'orange' ? 'text-orange-500' : 'text-emerald-400'}`} />}
            </button>
...
const ExpandableCard = ({ card, isExpanded, onToggle, themeColor }) => {
    const t = themes[themeColor];
    const ringClass = themeColor === 'blue' ? 'ring-blue-500/30' : themeColor === 'orange' ? 'ring-orange-500/30' : 'ring-emerald-500/30';
        ...
        transition-transform duration-300 flex flex-col shadow-2xl lg:relative lg:translate-x-0 ${sidebarOpen
                ...
                <div className="p-6 border-t border-slate-800 bg-[#162032]">
                    <div className="flex justify-between items-center mb-2 text-xs text-slate-400">
                        ...
                        <span>{activeUnitId === 'u2' ? '33%' : activeUnitId === 'u3' ? '66%' : '100%'}</span>
                    </div>
                    <div className="w-full bg-slate-700 rounded-full h-1.5">
                        <div className={`h-1.5 rounded-full transition-all duration-1000 ${t.bg}`} style={{
                            width:
                                activeUnitId === 'u2' ? '33%' : activeUnitId === 'u3' ? '66%' : '100%'
                        }}></div>
                    </div>
                </div>
            </aside>
            ...
            <main ref={mainContentRef}
                ...
                <div className="p-6 lg:p-12 max-w-6xl mx-auto w-full">
                    ...
                    {activeUnitId === 'u3' && (
                        <div className="py-12 text-center border-t border-slate-800 mt-12">
                            <p className="text-slate-500 mb-4">Has completado Yangming</p>
                            <button onClick={() => {
                                setActiveUnitId('u4');
                                mainContentRef.current.scrollTo({ top: 0, behavior: 'smooth' });
                            }}
                                className={`inline-flex items-center space-x-2 px-8 py-4 bg-emerald-600 hover:bg-emerald-500 text-white
                    rounded-full font-bold transition-all hover:scale-105 shadow-lg shadow-emerald-900/40`}
                            >
                                <span>Continuar a Unidad 4: Shaoyang</span>
                                <ArrowRight size={20} />
                            </button>
                        </div>
                    )}
                    ...
                    {activeUnitId === 'u4' && (
                        <div className="py-12 text-center border-t border-slate-800 mt-12">
                            ...
                            <p className="text-slate-500">Has dominado los conceptos de Taiyang, Yangming y Shaoyang.</p>
                        </div>
                    )}
